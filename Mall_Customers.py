...
preprocessing_override = pd.read_csv('Mall_Customers_Override.csv')

# Importing the dataset
dataset_X = pd.read_csv('Mall_Customers.csv')

"""
dataset_X = dataset_X.ix[:,3:5]
print (dataset_X.head(5))
preprocessing_override = preprocessing_override.ix[:, 3:5]
"""
